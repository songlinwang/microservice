package com.wangsonglin.user.controller;

import com.wangsonglin.thrift.user.UserInfo;
import com.wangsonglin.thrift.user.dto.UserDTO;
import com.wangsonglin.user.redis.RedisClient;
import com.wangsonglin.user.response.LoginResponse;
import com.wangsonglin.user.response.Response;
import com.wangsonglin.user.thrift.ServiceProvider;
